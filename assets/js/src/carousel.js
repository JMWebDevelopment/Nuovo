  ...
  */
  ...
  var myCarousel = (function() {
	...
	function init(set) {
	  ...
	  ctrls.innerHTML = '<li>' +
		  '<button type="button" class="btn-prev"><span class="fal fa-arrow-left"><span class="screen-reader-text">Previous Item</span></span></button>' +
		'</li>' +
		'<li>' +
		  '<button type="button" class="btn-next"><span class="fal fa-arrow-right"><span class="screen-reader-text">Next Item</span></span></button>' +
		'</li>';
	...
	function setSlides(new_current, setFocusHere, transition, announceItemHere) {
	  ...
	  carousel.style.height = slides[new_current].clientHeight + 'px';
	  console.log( slides[new_current].clientHeight + 'px' );
...
jQuery( document ).ready( function( $ ) {
	let sliderHeight = $( '#carousel .slide.current' ).height();
	$( '#carousel' ).height( sliderHeight );

	let sliderWidth = $( '#carousel' ).width();
	$( '#carousel .slide' ).width( sliderWidth );
	$( '#carousel ul' ).width( sliderWidth );
