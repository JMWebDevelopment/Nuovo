<?php
/**
 * Template part for displaying the second post section of the homepage.
 *
 * @package wp_rig
 */
...
if ( ( '' !== esc_attr( get_theme_mod( 'nuovo-category-two' ) ) ) && ( 'none' !== esc_attr( get_theme_mod( 'nuovo-category-two' ) ) ) ) {
	$category_id = esc_attr( get_theme_mod( 'nuovo-category-two' ) );
} else {
	$category_id = '';
}

if ( esc_attr( get_theme_mod( 'nuovo-category-two-count' ) ) ) {
	$cat_count = esc_attr( get_theme_mod( 'nuovo-category-two-count' ) );
} else {
	$cat_count = 3;
}
