...
if ( ( '' !== esc_attr( get_theme_mod( 'nuovo-category-three' ) ) ) && ( 'none' !== esc_attr( get_theme_mod( 'nuovo-category-three' ) ) ) ) {
	$category_id = esc_attr( get_theme_mod( 'nuovo-category-three' ) );
} else {
	$category_id = '';
}

if ( esc_attr( get_theme_mod( 'nuovo-category-three-count' ) ) ) {
	$cat_count = esc_attr( get_theme_mod( 'nuovo-category-three-count' ) );
} else {
	$cat_count = 3;
}
