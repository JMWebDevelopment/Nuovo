...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function load_color_stylesheet() {
		if ( 'red' === get_theme_mod( 'nuovo-color-theme' ) ) {
			wp_rig()->print_styles( 'wp-rig-red' );
		} elseif ( 'orange' === get_theme_mod( 'nuovo-color-theme' ) ) {
			wp_rig()->print_styles( 'wp-rig-orange' );
		} elseif ( 'yellow' === get_theme_mod( 'nuovo-color-theme' ) ) {
			wp_rig()->print_styles( 'wp-rig-yellow' );
		} elseif ( 'green' === get_theme_mod( 'nuovo-color-theme' ) ) {
			wp_rig()->print_styles( 'wp-rig-green' );
		} elseif ( 'blue' === get_theme_mod( 'nuovo-color-theme' ) ) {
			wp_rig()->print_styles( 'wp-rig-blue' );
		} elseif ( 'purple' === get_theme_mod( 'nuovo-color-theme' ) ) {
	...
	public function filter_body_classes( array $classes ) : array {
		if ( 'red' === get_theme_mod( 'nuovo-color-theme' ) ) {
			...
			$classes[] = 'has-orange-theme';
		} elseif ( 'yellow' === get_theme_mod( 'nuovo-color-theme' ) ) {
			$classes[] = 'has-yellow-theme';
		} elseif ( 'green' === get_theme_mod( 'nuovo-color-theme' ) ) {
