					...
					<div class="archive-featured-photo-area">
						<?php if (has_post_thumbnail()) { ?>
							<div class="archive-featured-photo">
								...
								<span class="archive-comments"><span class="photo-post-details-links"><?php echo the_time('M j, Y'); ?> &bull; <?php echo comments_popup_link('0', '1', '%', '', __('Off', 'nuovo')); ?><img src="<?php echo get_template_directory_uri(); ?>/images/comments.png" style="margin-top:3px; margin-left:3px;margin-bottom:-2px;" /></span></span>
							</div>
						<?php } ?>
					</div>
					<h3 class="archive-headline"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
					<p class="archive-meta-text"><?php _e('Written By: ', 'nuovo'); ?><?php the_author_posts_link(); ?> <?php _e('on', 'nuovo'); ?> <?php the_time('F j, Y'); ?>
